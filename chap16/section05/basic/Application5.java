package com.ohgiraffers.chap16.section05.basic;
...
public class Application5 {
    ...
    public static void main(String[] args) {
        ...
        List<String> booksByAuthor = books.stream()
                .filter(b -> Objects.equals(b.getAuthor(), "J.K. 롤링"))
                .map(Book::getTitle)
                .toList();// 코드 작성
        ...
        Map<Integer, Long> booksCountByYear = books.stream()
                .collect(Collectors.groupingBy(b->b.getPublicationYear(), Collectors.counting()));// 코드 작성
